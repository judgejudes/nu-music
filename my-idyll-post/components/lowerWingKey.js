...
// import lowerWing from '../data/clean-album-ratings';
import wingColors from '../data/wing-colors';
import lowerWing from '../data/lowerWing';
...
const LowerWingKey = ({ }) => {
    ...
    useEffect(() => {
        ...
        if (lowerWing && d3Container.current) {
            const svg = d3.select(d3Container.current);
            const flower = 100
            // console.log(flower)

            var g = svg.selectAll('g')
            .data(lowerWing).enter().append('g')
